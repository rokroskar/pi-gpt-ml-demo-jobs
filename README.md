...
Reusable Renku example showing how to run a non-interactive MNIST training job from a Zenodo data connector and launch a Streamlit inference dashboard. Python dependencies are specified in `requirements.txt` for the Renku Python buildpack.
